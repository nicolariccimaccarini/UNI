...
/*
 * ThreadLoad rappresenta la classe respondabile di tenere traccia del cpuLoad dei vari thread
 * analizzati da Monitor. Un'istanza di ThreadLoad verra' creata nel main e sara' condivisa
 * fra i thread Monitor e sorter
 */
...
public class ThreadLoad {
    ...
    /*
     * Inserisce l'informazione di cpuLoad riguardante il thread con id threadId
     * @param threadId
     * @param cpuLoad
     */
