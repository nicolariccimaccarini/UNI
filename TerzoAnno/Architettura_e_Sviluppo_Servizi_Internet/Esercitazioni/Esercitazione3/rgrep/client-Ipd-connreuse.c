...
int main(int argc, char** argv) {
    ...
    // a questo punto posso liberare la memoria allcoata da getaddrinfo
    freeaddrinfo(res);
    ...
    for (;;) {
        ...
        // Codifico lunghezza stringa1 come intero unsigned a 16 bit in formato big endian
