...
public class IterativeRemoteSquareServer {
    ...
    public static void main(String[] args) {
        try {
            if (args.length != 1) {
                System.out.println("Errore! La sintassi corretta e': java IterativeRemoteSquareServer porta");
                System.exit(1);
            }
            ...
            while (true) {
                ...
                while ((line = networkIn.readLine()) != null) {
                    ...
                    // possibile alternativa -> networkOut.write(N * N + "");
