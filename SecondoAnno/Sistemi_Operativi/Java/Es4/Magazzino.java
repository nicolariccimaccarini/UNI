...
public class Magazzino {
    ...
    // Ogni operazione richiede 500ms, sleep per implementare tale tempo di esecuzione
    ...
    public synchronized void increaseQuantity(String object, int qta) {
        if (verificaOggetto(object)) {
            ...
            if (value.intValue() + qta < 0) {
                System.err.println("Impossibile aggiornare la quantita, dato inserito non corretto");
                return;
            }
